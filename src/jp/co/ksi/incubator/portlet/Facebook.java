 ...
 * </pre>
 */
public class Facebook extends BaseBL
{
	private static Logger	log= Logger.getLogger( Facebook.class );
	protected Auth	auth;
			...
			throws Exception
	{
		...
		//	(3)サービス用のリクエストを組み立てる
		String	method= "GET";
		String	serviceURL= "https://graph.facebook.com/me/home?access_token="+ URLEncoder.encode( oauth.getAccess_token(), ENC_UTF8 ) +"&locale=ja_JP";
		...
		try
		{
			...
			http.setRequestProperty( "Accept-Language", "ja_JP" );
